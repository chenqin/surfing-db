...
set(KC_LIBRARY_PATH ${BINARY_DIR}/src/${CMAKE_FIND_LIBRARY_PREFIXES}rdkafka${CMAKE_SHARED_LIBRARY_SUFFIX})

message(STATUS "KC_LIBRARY_PATH=${KC_LIBRARY_PATH}")
message(STATUS "KC_INCLUDE_DIRS=${KC_INCLUDE_DIRS}")
...
set(KAFKA_LIBRARY_PATH ${BINARY_DIR}/src-cpp/${CMAKE_FIND_LIBRARY_PREFIXES}rdkafka++${CMAKE_SHARED_LIBRARY_SUFFIX})
