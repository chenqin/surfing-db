...
/**
 * metricsScope: jm: flink.jm._t_host.<host> jm.job:
 * flink.jm._t_host.<host>._t_job_id.<job_id>._t_job_name.<job_name> operator:
 * flink.operator._t_host.<host>._t_tm_id.<tm_id>._t_job_id.<job_id>._t_job_name
 ...
 * ._t_task_attempt_num.<task_attempt_num>._t_subtask_index.<subtask_index> tm:
 * flink.tm._t_host.<host>._t_tm_id.<tm_id> tm.job:
